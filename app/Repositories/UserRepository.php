...
class UserRepository extends BaseRepository {
     ...
     *
     * @param  Chitunet\Models\Content $content
     ...
     * 存储管理型用户
     *
     * @param  Chitunet\Models\User $manager
     * @param  array $inputs
     * @return Chitunet\Models\User
     */
